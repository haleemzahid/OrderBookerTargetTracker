    ...
    <div>
      ...
      <Row gutter={[16, 16]}>
        <Col xs={24} sm={12} md={6}>
          <Card>
            <Statistic
              title={language === 'ur' ? 'کل آرڈر بکر' : 'Total Order Bookers'}
        ...
        <Col xs={24} sm={12} md={6}>
          <Card>
            <Statistic
              title={language === 'ur' ? 'اس مہینے کی فروخت' : 'This Month Sales'}
        ...
        <Col xs={24} sm={12} md={6}>
          <Card>
            <Statistic
              title={language === 'ur' ? 'اس مہینے کی واپسی' : 'This Month Returns'}
        ...
        <Col xs={24} sm={12} md={6}>
          <Card>
            <Statistic
              title={language === 'ur' ? 'ٹارگٹ حاصلی' : 'Target Achievement'}
      ...
      <Row gutter={[16, 16]} style={{ marginTop: '24px' }}>
        <Col xs={24} lg={12}>
          <Card title={language === 'ur' ? 'بہترین کارکردگی' : 'Top Performers'}>
        ...
        <Col xs={24} lg={12}>
          <Card title={language === 'ur' ? 'توجہ درکار' : 'Needs Attention'}>
            <Space direction="vertical" style={{ width: '100%' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <span>Ali Ahmed</span>
