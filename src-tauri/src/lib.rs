...
pub fn run() {
    let migrations = vec![
        ...
        migrations::migration_010_create_companies_table::migration(),
        migrations::migration_011_create_products_table::migration(),
        migrations::migration_012_transform_daily_entries_structure::migration(),
    ];
